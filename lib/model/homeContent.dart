class HomePageContentModel {
  String code;
  String message;
  HomePageContentData data;

  HomePageContentModel({this.code, this.message, this.data});

  HomePageContentModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    message = json['message'];
    data = json['data'] != null
        ? new HomePageContentData.fromJson(json['data'])
        : null;
  }
...
class HomePageContentData {
  ...
  HomePageContentData.fromJson(Map<String, dynamic> json) {
    if (json['slides'] != null) {
