class DetailsModel {
  ...
  DetailsModel.fromJson(Map<String, dynamic> json) {
    ...
    data =
        json['data'] != null ? new DetailsGoods.fromJson(json['data']) : null;
  }
...
class DetailsGoods {
  ...
  DetailsGoods({this.goodInfo, this.goodComments, this.advertesPicture});

  DetailsGoods.fromJson(Map<String, dynamic> json) {
